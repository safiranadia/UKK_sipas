 ...
 * Send message route
 */
Route::post('/sendMessage', [CustomChatController::class, 'sendMessage'])->name('send.message');

/**
 * Fetch messages
 */
Route::post('/fetchMessages', [CustomChatController::class, 'fetch'])->name('fetch.messages');
