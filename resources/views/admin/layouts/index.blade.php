        ...
        <aside class="w-64 bg-white shadow-sm flex flex-col border-r border-gray-100">
            ...
            <div class="p-6 flex items-center">
                <div class="flex items-center text-blue-600">
                    <svg class="w-8 h-8 mr-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
            ...
            <nav class="flex-1 px-4 py-4 space-y-2">
                ...
                <a href="{{ route('admin.account-siswa') }}"
                    ...
                    {{ request()->routeIs('admin.account-siswa')
        ...
        <main class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-sm px-8 py-4 flex justify-between items-center z-30">
                <div class="flex items-center gap-2">
                    <h1 class="text-xl font-bold text-gray-900">Hallo, <span
                            class="text-blue-600">{{ Auth::user()->username ?? 'Administrator' }}</span>
                    </h1>
                    <span
                        class="text-gray-400 text-xs font-bold uppercase tracking-tight ml-4 border-l pl-4 border-gray-100">{{ now()->translatedFormat('l, d F Y') }}</span>
                </div>
                <div class="flex items-center gap-4">
                    <!-- Notification -->
                    <div x-data="{ openNotify: false }" class="relative">
                        <button @click="openNotify = !openNotify"
                            class="relative p-2.5 text-gray-400 hover:bg-gray-50 hover:text-blue-600 rounded-xl transition-all">
                        ...
                        <div x-show="openNotify" @click.away="openNotify = false" x-cloak
                            ...
                            <div class="p-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                                ...
                                <span
                                    class="px-2 py-0.5 bg-blue-100 text-blue-700 rounded-full text-[10px] uppercase font-bold tracking-wider">
