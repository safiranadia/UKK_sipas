...
<head>
    ...
    <title>SIPAS - Pengaduan Selesai</title>
    ...
    <div class="flex h-screen">
        ...
        <main class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="flex-1 overflow-auto p-8">
                <!-- Title -->
                <h2 class="text-2xl font-bold text-gray-900 mb-6">Daftar Pengaduan Selesai</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <!-- Action Button -->
                            <button class="px-6 py-2 bg-blue-400 hover:bg-blue-500 text-gray-900 font-medium rounded text-sm transition-colors">
                                Tanggapi
                            </button>
                        </div>
                    </div>
