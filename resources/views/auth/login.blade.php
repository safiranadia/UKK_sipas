...
<head>
    ...
    <style>
        ...
        /* Custom autofill style to match design */
    ...
    <div class="flex-grow flex items-center justify-center p-4 sm:p-6">
        <div class="w-full max-w-[420px] bg-light rounded-2xl shadow-soft p-8 sm:p-10 relative overflow-hidden"
            ...
            <form class="space-y-5" action="{{ route('login') }}" method="POST">
                ...
                <!-- Username -->
                <div>
                    <label for="login-username" class="block text-xs font-medium text-gray-600 mb-1.5">Email</label>
                ...
                <div x-data="{ show: false }">
                    <label for="login-password" class="block text-xs font-medium text-gray-600 mb-1.5">Password</label>
                    <div class="relative">
